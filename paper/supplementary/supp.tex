...
result of Section~4.4 of the main paper in the detail it deserves, and
answers, with new measurements rather than argument, five alternative
explanations for the main results raised across two rounds of review
(Section~\ref{sec:s8}). Every claim below is traceable to a specific file in
the project repository, cited inline by path.}
\end{center}

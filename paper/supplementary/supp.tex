...
$k=48\ldots128$ (past $N^\ast$)  & 0.50 & 0.50 & -0.02 \\
\bottomrule
\end{tabular}
\end{center}
...
\noindent\textbf{Limits.} One checkpoint (Llasa-1B), 12 items, one seed,
three cross-validation folds. It is a single clean observation. Two engineering

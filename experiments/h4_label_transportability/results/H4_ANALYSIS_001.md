...
| Supplementary vector heatmap | HDD `runs/h4_label_transportability/h4_analysis_001/figures/h4_label_cue_delta_auc_heatmap.pdf` | 48,386 | `7434d24b18aea1875d98e0ff60eb789994d2d5fee8668aedf566cff3670eedaa` |
| Supplementary 300-DPI heatmap | HDD `runs/h4_label_transportability/h4_analysis_001/figures/h4_label_cue_delta_auc_heatmap.png` | 340,825 | `4ab334393714ab691c38b48445c47577aef95e8a07bf216d971676f72a9fe741` |
...
`scripts/plot_h4_label_cue_heatmap.py` renders the exact 420-cell matrix as a
three-panel signed-AUROC heatmap, exporting vector PDF and 300-DPI PNG. It
accepts only the sealed H4 matrix and aggregation, revalidates their complete
score-free schema, and labels green square markers as *descriptive, not a
detector candidate*. Visual inspection confirms that labels, scale, panels, and
legend are readable. The figure is supplementary and is intentionally not
inserted into the four-page paper.

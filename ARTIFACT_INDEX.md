...
| H10 CD-ADD source-frozen follow-up | `experiments/future_directions/H10_CDADD_EXTERNAL_REPLICATION_PROTOCOL.md`, `H10_DECISION_RECORD_20260811.md` | `experiments/future_directions/results/H10_CDADD_TERMINAL_EVALUATION_001.md` | Complete terminal no-retune extension. The H9 P panel is lower than B1/B2 on all-trial CD-ADD with both paired intervals below zero, but misses H10's locked 10% P-versus-B1 relative-EER rule (8.30%). It cannot extend the H9 manuscript claim or trigger a new target/model search. |

...
| H9 content-aligned pair ranking | `experiments/h9_paired_counterfactual/PLAN.md` | `experiments/h9_paired_counterfactual/results/H9_TERMINAL_EVALUATION_001.md` | Complete positive controlled-transfer result. The locked four-seed P ensemble reaches 45.02% macro EER on SONAR+ArAD versus B1 51.78% and B2 52.01%; both 2,000-replicate shared-ID bootstrap CIs are below zero and all eight gate rules pass. It is not SOTA or a causal/general-mechanism claim; do not retune H9. |

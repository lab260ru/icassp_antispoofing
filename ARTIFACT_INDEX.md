...
| H8-SF robust score-fusion pivot | `experiments/h8_positive_pivot/PLAN.md` and `DATA.md` | No result artifact yet; protocol is locked before target data access. | A new source-trained, rank-space GroupDRO fusion study. It has three fixed source corpora, five blind primary targets, an eight-system frozen roster, mandatory fixed/ERM/V-REx comparators, and a stringent target gate. It cannot use H1--H7 to tune or select. |

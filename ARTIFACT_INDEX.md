...
| H9 content-aligned pair ranking | `experiments/h9_paired_counterfactual/PLAN.md` | `experiments/h9_paired_counterfactual/results/H9_SOURCE_FREEZE_001.md` | Independent active positive-result candidate. The shared matched-only ODSS source pool and B2 mapping are frozen; fresh-initialized BF16 fitting and fixed SONAR+ArAD evaluation remain pending. A failed provenance/strict gate stops H9 rather than licensing a new loss, target, or source. |

...
| H6 published-score agreement atlas | `experiments/h6_score_agreement/protocol.md` | `experiments/h6_score_agreement/results/H6_INPUT_FREEZE_001.md` | Its separate seed-2611 label-only freeze is complete and binds 40 original score artifacts before parsing. The only authorized next step is the frozen-manifest analysis; agreement is descriptive only. |

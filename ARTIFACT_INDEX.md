...
| H9 content-aligned pair ranking | `experiments/h9_paired_counterfactual/PLAN.md` | `experiments/h9_paired_counterfactual/results/H9_SOURCE_FREEZE_001.md`, `H9_SOURCE_MATERIALIZATION_001.md` | Independent active positive-result candidate. The shared matched-only ODSS source pool, B2 mapping, and canonical 23,883-WAV training manifest are frozen; fresh-initialized BF16 fitting and fixed SONAR+ArAD evaluation remain pending. A failed provenance/strict gate stops H9 rather than licensing a new loss, target, or source. |

...
- Follow-up: Rerun the association screen after that guardrail is tested, then use the separately implemented bootstrap confirmation stage only for prespecified or screen-selected candidates.
